...
class Louvain():
    ...
    def first_stage(self):
        ...
        visit_sequence_list = list(self._G.keys())
        random.shuffle(visit_sequence_list)
        while True:
            can_stop = True #第一阶段是否可终止
            for v_vid in visit_sequence_list:
...
if __name__ == '__main__':
    G = load_graph('C:/Users/User/Downloads/data/twitter_combined.txt')
    algorithm = Louvain(G)
